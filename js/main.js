...
/* ---------khai báo biến------------- */
let sliderItems = document.querySelectorAll('.slider__list-item ');
let currentSlider = 0;
...
/* --------kiểm tra và lấy index phần tử chứa "active" */
...
//number.innerHTML = (currentSlider + 1);
/* ----------fucntion change slider, dots, number------ */
...
menuItems.forEach(function (menu_item, index) {
    ...
    document.addEventListener('scroll', function () {
        ...
        if (scroll > sections[index].offsetTop - heightHeader - 5
...
let slider2Img = document.querySelectorAll('.image');
 ...
 document.addEventListener('scroll',function(){
     ...
     btnSlider2.forEach(function(btnItem,index){
        ...
        if(Y>=news.offsetTop - heightHeader -100 ){
